...
interface CryptographyManager {
    ...
    fun clearPersistCiphertextWrapper(
        context: Context,
        filename: String,
        mode: Int,
        prefKey: String
...
private class CryptographyManagerImpl : CryptographyManager {
    ...
    override fun getInitializedCipherForEncryption(keyName: String): Cipher {
        ...
        try {
            ...
            Log.e("Encryption", "===>>> KeyPermanentlyInvalidatedException")
        } catch (e: Exception) {
            Log.e("Encryption", "===>>> $e")
        }
        return cipher
    ...
    override fun getInitializedCipherForDecryption(
        ...
        try {
            ...
            Log.e("Decryption", "===>>> KeyPermanentlyInvalidatedException")
            try {
                val keyStore = KeyStore.getInstance(ANDROID_KEYSTORE)
                keyStore.load(null)
                keyStore.deleteEntry(keyName)
                val secretKey = prepareKey(keyName)
                //cipher.init(Cipher.DECRYPT_MODE, secretKey, GCMParameterSpec(128, initializationVector))
                return null
            } catch (e: Exception) {
                Log.e("Decryption", "===>>> exception after prepareKey:  $e")
            }
        } catch (e: Exception) {
            Log.e("Decryption", "===>>> $e")
        }
    ...
    private fun prepareKey(keyName: String): SecretKey {
    ...
    override fun clearPersistCiphertextWrapper(
        context: Context,
        filename: String,
        mode: Int,
        prefKey: String
